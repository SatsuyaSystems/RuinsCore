...
- Permission-System ueber `PermissionNode`-Enum + `PermissionManager`
- Jobsystem inkl. GUI-Verwaltung (Jobs: `holzfaeller`, `miner`, `builder`, `fischer`)
- Holzfaeller-Restriktionen fuer Nicht-Jobmitglieder beim Holzabbau
- Miner-Restriktion: nur Miner/Builder duerfen Erze abbauen
...
- Jobs aktuell: `holzfaeller`, `miner`, `builder`, `fischer`
- Nicht-Holzfaeller erhalten beim Holzabbau Laehmung und bekommen nur mit Chance Planken-Drops.
