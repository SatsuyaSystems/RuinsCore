...
/**
 * Speed Command - Ändere die Geschwindigkeit
 */
public final class SpeedCommand implements CoreCommand {
    ...
    public String getDescription() {
        return "Ändere die Bewegungsgeschwindigkeit.";
    }

    @Override
    public PermissionNode getPermission() {
        return PermissionNode.COMMAND_SPEED;
    }
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            if (!(sender instanceof Player)) {
                sender.sendMessage("§c/speed <Geschwindigkeit> [Spieler]");
                return true;
            }
        ...
        // Normalisiere auf 0.0-1.0 für setWalkSpeed/setFlySpeed
        ...
        if (player.equals(sender)) {
            player.sendMessage("§a✓ Geschwindigkeit auf §b" + speed + " §agesetzt.");
        } else {
            sender.sendMessage("§a✓ Geschwindigkeit von §b" + player.getName() + " §aauf §b" + speed + " §agesetzt.");
            player.sendMessage("§b" + sender.getName() + " §ehat deine Geschwindigkeit auf §b" + speed + " §egesetzt.");
        }
